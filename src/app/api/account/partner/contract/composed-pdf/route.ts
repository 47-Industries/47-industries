...
// GET /api/account/partner/contract/composed-pdf - Generate PDF with all signatures composited (partner view)
export async function GET(req: NextRequest) {
  try {
    ...
    // Use default positions for legacy signatures (last page)
